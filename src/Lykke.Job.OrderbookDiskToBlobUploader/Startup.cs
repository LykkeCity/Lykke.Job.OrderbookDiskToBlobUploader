...
namespace Lykke.Job.OrderbookDiskToBlobUploader
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                {
                    options.DefaultLykkeConfiguration("v1", "OrderbookDiskToBlobUploader API");
                });
                ...
                builder.RegisterModule(new JobModule(appSettings.CurrentValue.OrderbookDiskToBlobUploaderJob, Log));
        ...
        private static ILog CreateLogWithSlack(IServiceCollection services, IReloadingManager<AppSettings> settings)
        {
            ...
            var dbLogConnectionStringManager = settings.Nested(x => x.OrderbookDiskToBlobUploaderJob.LogsConnString);
            ...
            var persistenceManager = new LykkeLogToAzureStoragePersistenceManager(
                AzureTableStorage<LogEntity>.Create(dbLogConnectionStringManager, "OrderbookDiskToBlobUploaderLog", consoleLogger),
                consoleLogger);
